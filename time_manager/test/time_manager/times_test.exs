defmodule TimeManager.TimesTest do
  ...
  describe "clocks" do
    ...
    test "create_clock/1 with valid data creates a clock" do
      valid_attrs = %{status: true, time: ~N[2024-10-07 09:14:00]}

      assert {:ok, %Clock{} = clock} = Times.create_clock(valid_attrs)
      assert clock.status == true
      assert clock.time == ~N[2024-10-07 09:14:00]
    end
    ...
    test "update_clock/2 with valid data updates the clock" do
      clock = clock_fixture()
      update_attrs = %{status: false, time: ~N[2024-10-08 09:14:00]}

      assert {:ok, %Clock{} = clock} = Times.update_clock(clock, update_attrs)
      assert clock.status == false
      assert clock.time == ~N[2024-10-08 09:14:00]
    end
  ...
  describe "clocks" do
    ...
    test "create_clock/1 with valid data creates a clock" do
      valid_attrs = %{status: true, time: ~N[2024-10-07 09:19:00]}

      assert {:ok, %Clock{} = clock} = Times.create_clock(valid_attrs)
      assert clock.status == true
      assert clock.time == ~N[2024-10-07 09:19:00]
    end
    ...
    test "update_clock/2 with valid data updates the clock" do
      clock = clock_fixture()
      update_attrs = %{status: false, time: ~N[2024-10-08 09:19:00]}

      assert {:ok, %Clock{} = clock} = Times.update_clock(clock, update_attrs)
      assert clock.status == false
      assert clock.time == ~N[2024-10-08 09:19:00]
    end
  ...
  describe "workingtimes" do
    ...
    test "create_working_time/1 with valid data creates a working_time" do
      valid_attrs = %{end: ~N[2024-10-07 09:19:00], start: ~N[2024-10-07 09:19:00]}

      assert {:ok, %WorkingTime{} = working_time} = Times.create_working_time(valid_attrs)
      assert working_time.end == ~N[2024-10-07 09:19:00]
      assert working_time.start == ~N[2024-10-07 09:19:00]
    end
    ...
    test "update_working_time/2 with valid data updates the working_time" do
      working_time = working_time_fixture()
      update_attrs = %{end: ~N[2024-10-08 09:19:00], start: ~N[2024-10-08 09:19:00]}

      assert {:ok, %WorkingTime{} = working_time} = Times.update_working_time(working_time, update_attrs)
      assert working_time.end == ~N[2024-10-08 09:19:00]
      assert working_time.start == ~N[2024-10-08 09:19:00]
    end
  ...
  describe "clocks" do
    ...
    test "create_clock/1 with valid data creates a clock" do
      valid_attrs = %{status: true, time: ~N[2024-10-07 09:24:00]}

      assert {:ok, %Clock{} = clock} = Times.create_clock(valid_attrs)
      assert clock.status == true
      assert clock.time == ~N[2024-10-07 09:24:00]
    end
    ...
    test "update_clock/2 with valid data updates the clock" do
      clock = clock_fixture()
      update_attrs = %{status: false, time: ~N[2024-10-08 09:24:00]}

      assert {:ok, %Clock{} = clock} = Times.update_clock(clock, update_attrs)
      assert clock.status == false
      assert clock.time == ~N[2024-10-08 09:24:00]
    end
  ...
  describe "workingtimes" do
    ...
    test "create_working_time/1 with valid data creates a working_time" do
      valid_attrs = %{end: ~N[2024-10-07 09:24:00], start: ~N[2024-10-07 09:24:00]}

      assert {:ok, %WorkingTime{} = working_time} = Times.create_working_time(valid_attrs)
      assert working_time.end == ~N[2024-10-07 09:24:00]
      assert working_time.start == ~N[2024-10-07 09:24:00]
    end
    ...
    test "update_working_time/2 with valid data updates the working_time" do
      working_time = working_time_fixture()
      update_attrs = %{end: ~N[2024-10-08 09:24:00], start: ~N[2024-10-08 09:24:00]}

      assert {:ok, %WorkingTime{} = working_time} = Times.update_working_time(working_time, update_attrs)
      assert working_time.end == ~N[2024-10-08 09:24:00]
      assert working_time.start == ~N[2024-10-08 09:24:00]
    end
